...
class app(gui):    
    def resp(self):        
        self.btn = tk.Button(root, text ='browse file 1',fg='white',bg='black',width=30, command = lambda:guiobj.open_file(self.st)) 
        self.btn.pack() 

        self.btn2=tk.Button(root, text ='browse file 2',fg='white',bg='black',width=30, command = lambda:guiobj.open_file(self.st)) 
        self.btn2.pack()

        self.btn3=tk.Button(root, text ='Compare',fg='Yellow',bg='black',width=30, command = lambda:guiobj.compare()) 
        self.btn3.pack()
